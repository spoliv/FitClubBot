...
**Внимание: при развертывании проекта может возникнуть ошибка `raise TTFError('Can\'t open file "%s"' % fn)`. Решается добавление шрифтов `arial.ttf` в корень библиотеки: `venv/lib/python3.6/site-packages/reports/font`** 
